...
Route::get('/create-product', [ProductController::class, 'createBE'])->name('products.create');
Route::post('/products', [ProductController::class, 'storeBE'])->name('products.store');

// Route edit and update
Route::get('/edit-product/{id}', [ProductController::class, 'editBE'])->name('products.edit');
Route::put('/update-product/{id}', [ProductController::class, 'updateBE'])->name('products.update');
